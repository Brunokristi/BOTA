<div class="about">
    <div class="grid-container" style="height: 60vh;">
        ...
        <div class="grid-item text" style="grid-column: 4 / 10; grid-row: 1 / 3;">Sme na trhu už 30 rokov a  nebojíme sa žiadneho pojektu.</div>
        <div class="grid-item image" style="grid-column: 4 / 7; grid-row: 3 / 10;"><img src="{{ asset('images/vegetables.jpg') }}" alt="tomato" /></div>
        <div class="grid-item text" style="grid-column: 7 / 10; grid-row: 3 / 10;">Tradičná rodinná firma z Malaciek</div>
